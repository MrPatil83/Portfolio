          ...
          {skills.map((skill, id) => (
            <div key={id} className="flex flex-col items-center gap-3">
              ...
              <motion.p
                ...
                initial="hidden"
                whileInView={"visible"}
                className=" text-[0.800rem] md:text-sm lg:text-base xl:text-xl raleway"
              >
                {skill.title}
              </motion.p>
            </div>
          ...
          {history.map((historyItem, id) => (
            ...
            >
              ...
              <div className="poppins-regular">
                <h3 className=" text-sm md:text-base lg:text-xl xl:text-2xl poppins-regular">
                ...
                <ul className="mt-1.5 md:list-disc text-[0.700rem] raleway md:list-inside md:text-sm text-slate-300 lg:base xl:text-base md:ml-">
